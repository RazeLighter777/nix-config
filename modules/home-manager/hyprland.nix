{ pkgs, ... }:
{
  ...
  home-manager.users.justin.programs.wofi.enable = true;
  home-manager.users.justin.services.hyprpaper = {
    enable = true;
    settings = {
      ipc = "on";
      splash = false;
  ...
  home-manager.users.justin.home.pointerCursor = {
    gtk.enable = true;
    x11.enable = true;
  ...
  home-manager.users.justin.programs.kitty = {
    enable = true;
    settings = {
