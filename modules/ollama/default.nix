...
let
  customOllama = pkgs.ollama-cuda.overrideAttrs (_: {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "ollama"; repo = "ollama"; rev = "v0.11.4";
      sha256 = "sha256-joIA/rH8j+SJH5EVMr6iqKLve6bkntPQM43KCN9JTZ8=";
    };
    vendorHash = "sha256-SlaDsu001TUW+t9WRp7LqxUSQSGDF1Lqu9M1bgILoX4=";
  });
  inherit (lib) cmakeBool cmakeFeature;
  customLlamaCpp = (pkgs.llama-cpp.override { cudaSupport = true; rocmSupport = false; metalSupport = false; }).overrideAttrs (old: {
    pname = "llama-cpp"; version = "b6191";
    src = pkgs.fetchFromGitHub {
      owner = "ggerganov"; repo = "llama.cpp"; rev = "b6191";
